...
class FitnessLogStepsPopup extends StatefulWidget {
  const FitnessLogStepsPopup({super.key});

  @override
  State<FitnessLogStepsPopup> createState() => _FitnessLogStepsPopupState();
}

class _FitnessLogStepsPopupState extends State<FitnessLogStepsPopup> {
  @override
