...
class _AppointmentEditScreenState extends State<AppointmentEditScreen> {
  late AddNewAppointmentProvider provider;

  @override
  void initState() {
    super.initState();
    provider = Provider.of<AddNewAppointmentProvider>(context, listen: false);

    // Initialize data for editing
    WidgetsBinding.instance.addPostFrameCallback((_) {
      provider.initDataForEditAppointment(widget.appointment);
    });
  }
            ...
            child: SingleChildScrollView(
              ...
              AppGestures(
                onTap: () => provider.onTapSelectDate(context),
                    child: Row(
                      children: [
                        SvgPicture.asset('assets/images/svg/ic_bnb_meetings.svg'),
                        Expanded(
                          child: Row(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: AppButton(
                    btnHeight: 50.h,
                    onPressed: () => provider.addNewAppointmentApi(
                      context: context,
