...
class NutritionLogWaterPopup extends StatefulWidget {
  const NutritionLogWaterPopup({super.key});

  @override
  State<NutritionLogWaterPopup> createState() => _NutritionLogWaterPopupState();
}

class _NutritionLogWaterPopupState extends State<NutritionLogWaterPopup> {
  @override
