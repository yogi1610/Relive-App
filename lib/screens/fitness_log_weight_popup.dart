...
class FitnessLogWeightPopup extends StatefulWidget {
  const FitnessLogWeightPopup({super.key});

  @override
  State<FitnessLogWeightPopup> createState() => _FitnessLogWeightPopupState();
}

class _FitnessLogWeightPopupState extends State<FitnessLogWeightPopup> {
  @override
