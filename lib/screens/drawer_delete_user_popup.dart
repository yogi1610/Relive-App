...
class DeleteUserAccountPopup extends StatefulWidget {
  const DeleteUserAccountPopup({super.key});

  @override
  State<DeleteUserAccountPopup> createState() =>
      _DeleteAppointmentDialogueState();
}

class _DeleteAppointmentDialogueState extends State<DeleteUserAccountPopup> {
  @override
