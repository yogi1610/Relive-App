            ...
            selectedIndex == 1
                ? Padding(
                    ...
                    child: WeeklyDatePicker(
                      onDateChanged: (date) =>
                          provider.onDateChanged(date: date),
                    ),
                  )
                : SizedBox.shrink(),
            Expanded(
              child: Padding(
                ...
                child: provider.appointmentList.isEmpty
                    ? Center(
                        child: AppText(
                          AppString.noInformationFound.tr(),
                          style: TextStyle(
                            fontSize: 12,
                            color: theme.onSecondaryFixedVariant,
                          ).poppinsRegular,
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          var item = provider.appointmentList[index];
                          return AppGestures(
                            onTap: () {
                                  ...
                                  Expanded(
                                    child: Align(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          AppText(
                                            AppDateOrTimeFormat.formatToHumanReadable(
                                  ...
                                  Expanded(
                                    child: Align(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          AppText(
                                            'John Smith', // need to make it dynamic
                                            style: TextStyle(
                                              fontSize: 14,
                                            ).poppinsSemiBold,
                                          ),
...
Map<String, dynamic> appointTypeInfo(String type) {
  if (type == AppointmentType.consultation.name) {
    return {'color': AppColors.kBlue, 'type': AppString.consultation.tr()};
  } else if (type == AppointmentType.injection.name) {
    return {'color': AppColors.kGreen, 'type': AppString.injection.tr()};
  } else if (type == AppointmentType.followup.name) {
    return {'color': Color(0xFFD97706), 'type': 'Follow-up'};
  } else {
    return {'color': AppColors.appColor, 'type': type.toString()};
  }
}
